export const generalTranslations = {
    en: {
        ...
        classroomHelperText: 'Classroom helper',
        classroomHelperCommand: '/classroom_helper',
    ...
    ua: {
        ...
        classroomHelperText: 'Classroom помічник',
        classroomHelperCommand: '/classroom_помічник',

        testingText: 'Тестування',
